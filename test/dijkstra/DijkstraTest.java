...
public class DijkstraTest {
	...
	public void setUp() throws Exception {
		...
		grafoMinimo = TesteUtil
				.importaGrafo(new File("grafoDijkstraMinimo.xml"));
	}

	@Test
	public void test() {
		Dijkstra dijkstra = Dijkstra.instance(grafoMinimo);
		List<Vertice> caminho = dijkstra.de("A").ate("C").retornaCaminho();
		TesteUtil.assertCaminho(caminho, "AC");
		caminho = dijkstra.de("A").ate("B").retornaCaminho();
		TesteUtil.assertCaminho(caminho, "AB");
	}
